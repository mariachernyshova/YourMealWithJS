export const modalProduct = document.querySelector('.modal_product'); // модалка продукта
export const catalogList = document.querySelector('.catalog__list'); // список продуктов
